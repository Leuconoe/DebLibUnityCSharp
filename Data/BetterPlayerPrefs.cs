...
public static class BetterPlayerPrefs
{
    ...
    private static readonly string fileName = DebLib.DebUtil.persistentDataPath + "/PlayerPrefs.txt";
    private static readonly string secureFileName = DebLib.DebUtil.persistentDataPath + "/AdvancedPlayerPrefs.txt";
